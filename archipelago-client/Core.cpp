			...
			if (s_inWorldStableTicks >= 2) {
				...
				if (!pendingStartItems.empty()) {
					if (startItemsGranted) {
						...
						for (const auto& si : pendingStartItems)
							er_ap::game::GrantFullID(si.first, si.second);
